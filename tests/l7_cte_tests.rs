...
fn test_l7_recursive_cte_hierarchy() {
    ...
    vm.execute_sql("CREATE TABLE emp (id INTEGER, name TEXT, manager_id INTEGER);")
        .unwrap();
    vm.execute_sql("INSERT INTO emp VALUES (1, 'CEO', NULL);")
        .unwrap();
    vm.execute_sql("INSERT INTO emp VALUES (2, 'VP', 1);")
        .unwrap();
    vm.execute_sql("INSERT INTO emp VALUES (3, 'Manager', 2);")
        .unwrap();
    vm.execute_sql("INSERT INTO emp VALUES (4, 'Engineer', 3);")
        .unwrap();
